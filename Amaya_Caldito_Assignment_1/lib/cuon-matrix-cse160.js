...
class Vector3 {
    ...
    add(other) {
        ...
        this.elements[0] += other.elements[0]; // Update X
        this.elements[1] += other.elements[1]; // Update Y
        this.elements[2] += other.elements[2]; // Update Z
    ...
    div(scalar) {
        ...
        // Divide each component (x, y, z) by the scalar
        this.elements[0] = this.elements[0] / scalar; // Update X
        this.elements[1] = this.elements[1] / scalar; // Update Y
        this.elements[2] = this.elements[2] / scalar; // Update Z
        // Don't delete the return statement.
        return this;
    };
    ...
    normalize() {
        ...
        // 2. Check to ensure we don't divide by zero 
        if (m > 0) {
            // 3. Divide this vector's elements by its magnitude 
            // You can call your div function directly!
            this.div(m); 
        } else {
