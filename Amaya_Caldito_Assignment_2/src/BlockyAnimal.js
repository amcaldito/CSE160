...
function renderAllShapes() {
  ...
  tail3.render();
  var spike1 = new Cone();
  spike1.color = [0.3, 0.5, 0.1, 1.0];
  spike1.matrix.set(yellowCoordinatesMat);
  spike1.matrix.translate(0.3, 0.5, 0.4); 
  spike1.matrix.scale(0.1, 0.2, 0.1);
  spike1.render();
  var spike2 = new Cone();
  spike2.color = [0.3, 0.5, 0.1, 1.0];
  spike2.matrix.set(yellowCoordinatesMat);
  spike2.matrix.translate(0.3, 0.5, 0.65); 
  spike2.matrix.scale(0.1, 0.2, 0.1);
  spike2.render();
